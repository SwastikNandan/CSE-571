...
"""autogenerated by genpy from planning/PlaceActionMsgRequest.msg. Do not edit."""
import sys
...
class PlaceActionMsgRequest(genpy.Message):
  _md5sum = "8370e30a1d89915978ee51d517c07a20"
  _type = "planning/PlaceActionMsgRequest"
...
string orientation
"""
  __slots__ = ['book_name','bin_name','x','y','orientation']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       book_name,bin_name,x,y,orientation
...
def _get_struct_2d():
    ...
    return _struct_2d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from planning/PlaceActionMsgResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PlaceActionMsgResponse(genpy.Message):
  ...
  _type = "planning/PlaceActionMsgResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class PlaceActionMsg(object):
  _type          = 'planning/PlaceActionMsg'
  _md5sum = '21274a3fa6a4a3f1484b941e2e263033'
