...
"""autogenerated by genpy from group_15/GetSuccessorRequest.msg. Do not edit."""
import sys
...
class GetSuccessorRequest(genpy.Message):
  ...
  _type = "group_15/GetSuccessorRequest"
...
def _get_struct_2d():
    ...
    return _struct_2d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from group_15/GetSuccessorResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetSuccessorResponse(genpy.Message):
  ...
  _type = "group_15/GetSuccessorResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64 x
float64 y
string direction
