...
"""autogenerated by genpy from search/GetSuccessorRequest.msg. Do not edit."""
import sys
...
class GetSuccessorRequest(genpy.Message):
  ...
  _type = "search/GetSuccessorRequest"
...
def _get_struct_2d():
    ...
    return _struct_2d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from search/GetSuccessorResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetSuccessorResponse(genpy.Message):
  ...
  _type = "search/GetSuccessorResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64[] x
float64[] y
string[] direction
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.g_cost))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.g_cost = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action = []
