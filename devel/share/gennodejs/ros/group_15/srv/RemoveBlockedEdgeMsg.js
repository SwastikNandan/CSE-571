...
class RemoveBlockedEdgeMsgRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('bowlname')) {
        this.bowlname = initObj.bowlname
      }
      else {
        this.bowlname = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [bowlname]
    bufferOffset = _serializer.string(obj.bowlname, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [bowlname]
    data.bowlname = _deserializer.string(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += object.bowlname.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.bowlname !== undefined) {
      resolved.bowlname = msg.bowlname;
    }
    else {
      resolved.bowlname = ''
    }
...
module.exports = {
  ...
  md5sum() { return '0f0367b18a799bf48809c710a3edf27a'; },
  datatype() { return 'group_15/RemoveBlockedEdgeMsg'; }
};
