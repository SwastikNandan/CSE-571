...
(cl:defmethod cl:initialize-instance :after ((m <CheckEdge-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckEdge-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reinforcement-srv:<CheckEdge-request> is deprecated: use reinforcement-srv:CheckEdge-request instead.")))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <CheckEdge-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:x1-val is deprecated.  Use reinforcement-srv:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <CheckEdge-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:y1-val is deprecated.  Use reinforcement-srv:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <CheckEdge-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:x2-val is deprecated.  Use reinforcement-srv:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'y2-val :lambda-list '(m))
(cl:defmethod y2-val ((m <CheckEdge-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:y2-val is deprecated.  Use reinforcement-srv:y2 instead.")
  (y2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckEdge-request>)))
  ...
  "reinforcement/CheckEdgeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckEdge-request)))
  "Returns string type for a service object of type 'CheckEdge-request"
  "reinforcement/CheckEdgeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CheckEdge-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckEdge-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reinforcement-srv:<CheckEdge-response> is deprecated: use reinforcement-srv:CheckEdge-response instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <CheckEdge-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:value-val is deprecated.  Use reinforcement-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckEdge-response>)))
  ...
  "reinforcement/CheckEdgeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckEdge-response)))
  "Returns string type for a service object of type 'CheckEdge-response"
  "reinforcement/CheckEdgeResponse")
