...
(cl:defmethod cl:initialize-instance :after ((m <ActionMsg-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionMsg-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reinforcement-srv:<ActionMsg-request> is deprecated: use reinforcement-srv:ActionMsg-request instead.")))

(cl:ensure-generic-function 'action_name-val :lambda-list '(m))
(cl:defmethod action_name-val ((m <ActionMsg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:action_name-val is deprecated.  Use reinforcement-srv:action_name instead.")
  (action_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActionMsg-request>)))
  ...
  "reinforcement/ActionMsgRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActionMsg-request)))
  "Returns string type for a service object of type 'ActionMsg-request"
  "reinforcement/ActionMsgRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ActionMsg-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionMsg-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reinforcement-srv:<ActionMsg-response> is deprecated: use reinforcement-srv:ActionMsg-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ActionMsg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:success-val is deprecated.  Use reinforcement-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'next_state-val :lambda-list '(m))
(cl:defmethod next_state-val ((m <ActionMsg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:next_state-val is deprecated.  Use reinforcement-srv:next_state instead.")
  (next_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActionMsg-response>)))
  ...
  "reinforcement/ActionMsgResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActionMsg-response)))
  "Returns string type for a service object of type 'ActionMsg-response"
  "reinforcement/ActionMsgResponse")
