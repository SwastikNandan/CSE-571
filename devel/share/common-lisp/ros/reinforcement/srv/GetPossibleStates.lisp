...
(cl:defmethod cl:initialize-instance :after ((m <GetPossibleStates-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPossibleStates-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reinforcement-srv:<GetPossibleStates-request> is deprecated: use reinforcement-srv:GetPossibleStates-request instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <GetPossibleStates-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:state-val is deprecated.  Use reinforcement-srv:state instead.")
  (state m))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <GetPossibleStates-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:action-val is deprecated.  Use reinforcement-srv:action instead.")
  (action m))

(cl:ensure-generic-function 'action_params-val :lambda-list '(m))
(cl:defmethod action_params-val ((m <GetPossibleStates-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:action_params-val is deprecated.  Use reinforcement-srv:action_params instead.")
  (action_params m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPossibleStates-request>)))
  ...
  "reinforcement/GetPossibleStatesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPossibleStates-request)))
  "Returns string type for a service object of type 'GetPossibleStates-request"
  "reinforcement/GetPossibleStatesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetPossibleStates-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPossibleStates-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reinforcement-srv:<GetPossibleStates-response> is deprecated: use reinforcement-srv:GetPossibleStates-response instead.")))

(cl:ensure-generic-function 'states-val :lambda-list '(m))
(cl:defmethod states-val ((m <GetPossibleStates-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reinforcement-srv:states-val is deprecated.  Use reinforcement-srv:states instead.")
  (states m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPossibleStates-response>)))
  ...
  "reinforcement/GetPossibleStatesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPossibleStates-response)))
  "Returns string type for a service object of type 'GetPossibleStates-response"
  "reinforcement/GetPossibleStatesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPossibleStates)))
  ...
  "reinforcement/GetPossibleStates")