...
(cl:defmethod cl:initialize-instance :after ((m <IsGoalState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IsGoalState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning-srv:<IsGoalState-request> is deprecated: use planning-srv:IsGoalState-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <IsGoalState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IsGoalState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning-srv:<IsGoalState-response> is deprecated: use planning-srv:IsGoalState-response instead.")))

(cl:ensure-generic-function 'is_goal-val :lambda-list '(m))
(cl:defmethod is_goal-val ((m <IsGoalState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planning-srv:is_goal-val is deprecated.  Use planning-srv:is_goal instead.")
  (is_goal m))
