...
(cl:defmethod cl:initialize-instance :after ((m <GetGoalState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGoalState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning-srv:<GetGoalState-request> is deprecated: use planning-srv:GetGoalState-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetGoalState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGoalState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planning-srv:<GetGoalState-response> is deprecated: use planning-srv:GetGoalState-response instead.")))
