...
(cl:defmethod cl:initialize-instance :after ((m <GetInitialState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInitialState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name search-srv:<GetInitialState-request> is deprecated: use search-srv:GetInitialState-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetInitialState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetInitialState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name search-srv:<GetInitialState-response> is deprecated: use search-srv:GetInitialState-response instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <GetInitialState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader search-srv:x-val is deprecated.  Use search-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <GetInitialState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader search-srv:y-val is deprecated.  Use search-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <GetInitialState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader search-srv:direction-val is deprecated.  Use search-srv:direction instead.")
  (direction m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetInitialState-response>)))
  ...
  "search/GetInitialStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetInitialState-response)))
  "Returns string type for a service object of type 'GetInitialState-response"
  "search/GetInitialStateResponse")
